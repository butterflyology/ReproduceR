...
objectives:
- "Learn the use of git and github for version control."
keypoints:
- "Version control is an important component of reproducible research"
---
...
1. Click the initiate a README.md file option. (May want to rethink this with `RStudio`)
...
_tip_: Notice that you can use markdown syntax. Use [this guide](https://help.github.com/articles/getting-started-with-writing-and-formatting-on-github/) for Github's flavor of Markdown. Use the "Preview" button to view the formatting of your `readme.md` file.
